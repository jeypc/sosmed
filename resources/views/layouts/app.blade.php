...
<body>
    <div id="app">
                        ...
                        @else
                            ...
                            <li>
                                <form class="navbar-form" action="{{ route('search') }}" method="GET">
                                    <input type="text" name="query" class="form-control" placeholder="Search friend here">
                                </form>
                            </li>
        ...
        <audio id="notif_sound">
            ...
            <source src="{{ asset('audio/notif.wav') }}" type="audio/wav">
        </audio>
    </div>
    ...
    <script>
        function noty(text, status='success'){
            new Noty({
                theme: 'metroui',
                type: status,
                layout: 'bottomRight',
